...
const routes: Routes = [
    {
        ...
        children: [
            ...
            {path: 'manageWorks',  loadChildren:'./manage-works/manage-works.module#ManageWorksModule'},
            {path: 'assignWorks',  loadChildren:'./assign-works/assign-works.module#AssignWorksModule'},
            {path: 'assignWorks/:objectId',  loadChildren:'./assign-works/assign-works.module#AssignWorksModule'},
